        ...
        switch (requestCode) {
            case 11:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    } else if (userInput.contains("animals") && !(userInput.contains("original") || userInput.contains("colors") || userInput.contains("fruits"))) {
                        Intent startGame1 = new Intent(StartPageController.this, GameStartActivity.class);
                        startGame1.putExtra(THEME, 1);
                        startActivity(startGame1);
                    } else if (userInput.contains("colors") && !(userInput.contains("original") || userInput.contains("animals") || userInput.contains("fruits"))) {
                    ...
                    } else if (userInput.contains("fruits") && !(userInput.contains("original") || userInput.contains("animals") || userInput.contains("colors"))) {
                        Intent startGame3 = new Intent(StartPageController.this, GameStartActivity.class);
                        startGame3.putExtra(THEME, 3);
